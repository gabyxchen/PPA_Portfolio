...
**Pause here** Look at the data. What do you suspect the coordinate system is? What do you notice about the date and time structure? The data is possibly in WGS 84 coordinate system because it contains longitude and latitude data. Data and time structure is in "M/D/Y H:MM".
...
**Question:** When are the peak hours? How do weekends differ from weekdays? On weekdays, peak hours are 7-8am and 17-18pm. Weekends do not show clear peak hour patterns.
...
**Question** These data are in WGS84. If you wanted to calculate a spatial distance-based variable, like a buffer, should you use the dataset as it? We should project the dataset onto a state plane coordinate system.
