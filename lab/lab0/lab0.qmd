...
car_data <- read_csv("C:/Users/Gab/OneDrive/Documents/SPRING 2026/CPLN5920_PPA/PPA_Portfolio/lab/lab0/car_sales_data.csv")
```
...
- Problematic names: Engine size, Fuel type, Year of manufacture; R doesn't recognize spaces.
...
**Your answer:** Data frame let you see everything, but a tibble only shows the first 10 rows.
...
**Your answer:** Because there's spaces in 'Year of manufacture'.
...
car_data %>%
  filter(price_category == "high-end", Mileage < 30000)
```
