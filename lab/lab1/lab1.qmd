...
**State Selection:** I have chosen **Rhode Island** for this analysis because: I lived in RI for 5 years.
...
acs2022 <- get_acs(geography = "county", variables = c(totpop = "B01003_001", medinc = "B19013_001"),
        state = "RI", survey = "acs5", year = 2022, output = "wide")

# Clean the county names to remove state name and "County" 
# Hint: use mutate() with str_remove()
acs2022_clean <- acs2022 %>%
  mutate(
    county_name = str_remove(NAME, " County, Rhode Island")
  )
