...
**Comment on the output:** [Using filter() to select a certain number of observations requires you to have a basic understanding of your data frame.]
...
pa_data %>%
  mutate(
    MOE_white = round(whiteM / whiteE, 3) * 100,
    MOE_black = round(blackM / blackE, 3) * 100,
    MOE_his_lat = round(his_latM / his_latE, 3) * 100
  )
