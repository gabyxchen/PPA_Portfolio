...
## Post-Pandemic Filings Offer a More Stable Modeling Window
...
## Monthly Filings Stabilize After Pandemic Disruption

![](image/monthly-filings-after-2020.png){fig-align="center" width="95%"}

## Eviction Filings Are Highly Skewed

![](image/eviction-filings-highly-skewed.png){width="95%"}

## Skewed Filing Counts Support Count Models and Risk Flags
...
![](image/spatial-patterns-eviction-risk.png){fig-align="center"}

## Spatial Hotspots Point to Stronger Assistance Targets
...
| Model            | Scale     | Test MAE | Test RMSE | Correlation |
|------------------|-----------|---------:|----------:|------------:|
...
## Rolling Monthly Baseline Has the Lowest Error

| Selection criterion | Best model | Scale | Test MAE | Test RMSE | Correlation |
|----|----|----|---:|---:|---:|
| Lowest error | Rolling-mean temporal baseline | Monthly | 1.657 | 2.441 | 0.678 |
| Strongest ranking | Simple temporal baseline | Quarterly | 3.718 | 5.422 | 0.779 |
| Richer covariates | NB with rent and income covariates | Monthly | 2.137 | 4.265 | 0.594 |
...
## Monthly Forecasts Better Match Time-Sensitive Outreach
...
![](image/monthly-model-diagnostics.png){fig-align="center"}
...
![](image/quarterly-model-diagnostics.png){fig-align="center"}
